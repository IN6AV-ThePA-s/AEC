...
export const CardHotelEvents = ({ name, description, type, maxPersons, price, hotel, butDelete, butEdit, id, dataUser }) => {
                    ...
                    <div className="card-body">
                        <div className='row'>
                            <div className='col-md-7'>
                                ...
                                <input type="text" readOnly={read} id={`inputNameEvent${id}`} defaultValue={name} name='name' className='form-control textNormalHotel' />
                            </div>
                            <div className='col-md-5'>
                                <h4 className='text-center'>Type</h4>
                                <select disabled={read} className="form-control textNormalHotel" id={`inputTypeEvent${id}`} defaultValue={type} name='type' >
                        ...
                        <div className='row mt-2'>
                            <div className='col-md-8'>
                                ...
                                <input readOnly={read} type="text" id={`inputMaxCapEvent${id}`} defaultValue={maxPersons} name='maxPersons' className='form-control textNormalHotel' />
                            </div>
                            <div className='col-md-4'>
                                <h4 className='text-center'>Price</h4>
                                <input readOnly={read} type="text" id={`inputPriceEvent${id}`} defaultValue={price} name='price' className='form-control textNormalHotel' />
                            </div>
                        </div>

                        <div className='mt-2'>
                            <h4 className='text-center'>Description</h4>
                            <textarea readOnly={read} id={`inputDescriptionEvent${id}`} className="form-control textNormalHotel" name='description' defaultValue={description} aria-label="With textarea"></textarea>
                        </div>
                        {
                            dataUser === 'CLIENT' ? (
                                <></>
