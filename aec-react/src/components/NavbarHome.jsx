...
export const NavbarHome = () => {
    return (
        <>
            <header>
                <div>
                    <h3 className="h3247 float-md-start mb-0"><img src={logo} width='50rem' height='60rem' /></h3>
                    <nav className="nav nav-masthead justify-content-center float-md-center pt-3">
